...
menu_template =TemplateSendMessgae(alt_Text= 'this', template = ButtonsTemplate(text =  '1/2', actions = [MessageTemplateAction(label = '1', text = '1'), MessageTemplateAction(label = '2', text = '2')]))
